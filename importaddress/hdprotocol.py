...
class serialize(object):
    ...
    def initialize(self):
        ...
        self.check_custom_module()

        # whether cointype match path. using tuple or list to trigger custom version bytes
        vers_from_db = self.check_version_byte()

        # Correct path
        self.correct_path(vers_from_db)

        # preparing generate child-key
        self._path()

    def check_custom_module(self):
